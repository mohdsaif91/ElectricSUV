    ...
    <>
      <Navbar expand="xl" fixed='top' className="navbar p-0 pb-2 pt-2 m-0 " >
        <Container className='p-0 '>
          <Navbar.Toggle aria-controls="offcanvasNavbar-expand-xl" className='navbarToggleIcon' ></Navbar.Toggle>
          <Navbar.Brand href="#">
            <img
              ...
              <Nav className="justify-content-end flex-grow-1 align-items-center p-0 m-0 " id='suv-navbar'>
                ...
                <Nav.Item>
                  <Nav.Link className='m-0 p-0 pt-2 pb-2 '>
                    <button type="button" className="btn btn-outline-light d-md-none d-lg-block d-sm-none spbtn1" 
                ...
                <Nav.Item>
                  <Nav.Link className='p-0 '>
                    <button className="d-md-block d-sm-block d-lg-none btn btn-link p-2 pt-0 border border-0 spbtn2"
                      onClick={() => setShow(!show)}
                    >
      ...
      <UpdateMeFormComponent show={show} setShow={setShow} formHeader={props.fields.formHeader.value} 
        formBody={props.fields.formBody.value} checkboxItems={props.fields.checkboxItems} />
    </>
  )
}
